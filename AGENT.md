...
- Source codebase: /Users/penghuo/oss/oh-my-kiro/
- Node.js ≥20 required
...
- The kiro-cli worker support (generateKiroWorkerAgentConfig, translateWorkerLaunchArgsForCli kiro branch, etc.) already exists in the source — just needs the omk→omk rename applied
