...
Your task is to implement functionality as described in specs/* and fix_plan.md.
...
When the tests pass, update fix_plan.md, then git add -A and git commit with a descriptive message.
